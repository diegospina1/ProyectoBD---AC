...
public class Pacientes {
    ...
    private String fecha_adq_plan;

    public Pacientes(int documento_pac, String nombre_pac, String apellido_paterno, String apellido_materno, String direccion_res, int cod_plan, String fecha_adq_plan) {
    ...
    public String getFecha_adq_plan() {
        return fecha_adq_plan;
    }

    public void setFecha_adq_plan(String fecha_adq_plan) {
        this.fecha_adq_plan = fecha_adq_plan;
    }
    ...
    public String toString() {
        ...
        sb.append(", cod_plan=").append(cod_plan);
